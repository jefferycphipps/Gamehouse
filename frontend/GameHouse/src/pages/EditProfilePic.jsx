...
const savePhoto = async() =>{
  ...
  try{
    ...
    const responser = await photo(formData);
...
return(
    ...
    <label className="form-control w-full max-w-xs">
      ...
      <input type="file" accept = "image/*" name = "file" className="file-input file-input-bordered w-full max-w-xs" onChange={setPhoto} />
      <button type="submit" className="btn btn-primary"  onClick={savePhoto}>Submit!</button>
      <div className="label">
